...
Task1: Add queries to retrieve the data from you database.
...
Task2: Add queries that work with multiple table to retrieve the data from you database.
...
Task3: Add statements to work with the db.
